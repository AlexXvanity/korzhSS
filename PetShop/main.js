...
function init () {
    ...
    petShopView.render(petShop.getAllCats(), 'Cats');

    petShopView.render(petShop.getExpensivePets(), 'Expensive Pets');

    petShopView.render(petShop.getFluffyOrWhite(), 'Fluffy or White Color');
}
